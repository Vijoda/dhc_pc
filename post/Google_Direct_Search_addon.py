...
#     #     ]
#
#     found_data = pre_processing[pre_processing['People_Checker_Status'] != '']
...
def filter_output(output_file):
    output_file_data=get_pre_proccesed_output(output_file)
    working_output=output_file_data[output_file_data['People_Checker_Status']=='Found']
